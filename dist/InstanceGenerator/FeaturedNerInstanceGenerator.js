(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./NerInstanceGenerator", "../Attribute/IsNumberAttribute", "../Attribute/IsOrganizationAttribute", "../Attribute/IsMoneyAttribute", "../Attribute/MainPosAttribute", "../Attribute/Predicate", "../Attribute/LastIGContainsTagInstrumentalAttribute", "../Attribute/LastIGContainsTagGenitiveAttribute", "../Attribute/LastIGContainsTagAccusativeAttribute", "../Attribute/LastIGContainsTagAblativeAttribute", "../Attribute/LastIGContainsPossessiveAttribute", "../Attribute/IsTimeAttribute", "../Attribute/IsRealAttribute", "../Attribute/IsProperNounAttribute", "../Attribute/IsPersonGazetteer", "../Attribute/IsOrganizationGazetteer", "../Attribute/IsAdjectiveAttribute", "../Attribute/IsAuxiliaryVerbAttribute", "../Attribute/IsCapitalAttribute", "../Attribute/IsDateAttribute", "../Attribute/IsFractionAttribute", "../Attribute/IsHonorificAttribute", "../Attribute/IsLocationGazetteer", "../Attribute/RootPosAttribute", "../Attribute/RootFormAttribute", "../Attribute/CaseAttribute", "nlptoolkit-classification/dist/Attribute/BinaryAttribute", "nlptoolkit-classification/dist/Attribute/DiscreteAttribute"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.FeaturedNerInstanceGenerator = void 0;
    ...
    const IsPersonGazetteer_1 = require("../Attribute/IsPersonGazetteer");
    const IsOrganizationGazetteer_1 = require("../Attribute/IsOrganizationGazetteer");
    ...
    const IsLocationGazetteer_1 = require("../Attribute/IsLocationGazetteer");
    ...
    class FeaturedNerInstanceGenerator extends NerInstanceGenerator_1.NerInstanceGenerator {
        /**
        ...
        addAttributesForWords(current, sentence, wordIndex) {
            ...
            current.addAttribute(new IsLocationGazetteer_1.IsLocationGazetteer(word.getName()));
            ...
            current.addAttribute(new IsOrganizationGazetteer_1.IsOrganizationGazetteer(word.getName()));
            current.addAttribute(new IsPersonGazetteer_1.IsPersonGazetteer(word.getName()));
    ...
    exports.FeaturedNerInstanceGenerator = FeaturedNerInstanceGenerator;
});
//# sourceMappingURL=FeaturedNerInstanceGenerator.js.map