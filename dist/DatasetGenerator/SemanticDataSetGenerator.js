(function (factory) {
    ...
    exports.SemanticDataSetGenerator = void 0;
    const DataSetGenerator_1 = require("./DataSetGenerator");
    class SemanticDataSetGenerator extends DataSetGenerator_1.DataSetGenerator {
        /**
         ...
         */
        constructor(directory, pattern, semanticInstanceGenerator) {
            super(directory, pattern, true, semanticInstanceGenerator);
        }
    }
    exports.SemanticDataSetGenerator = SemanticDataSetGenerator;
});
//# sourceMappingURL=SemanticDataSetGenerator.js.map