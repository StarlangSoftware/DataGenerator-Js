...
export declare class DisambiguationDataSetGenerator extends DataSetGenerator {
    /**
     ...
     */
    constructor(directory: string, pattern: string, includePunctuation: boolean, disambiguationInstanceGenerator: DisambiguationInstanceGenerator);
}
