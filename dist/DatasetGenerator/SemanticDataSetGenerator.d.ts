...
export declare class SemanticDataSetGenerator extends DataSetGenerator {
    /**
     ...
     */
    constructor(directory: string, pattern: string, semanticInstanceGenerator: SemanticInstanceGenerator);
}
